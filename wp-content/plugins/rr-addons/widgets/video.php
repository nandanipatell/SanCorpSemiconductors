 ...
 * @since 1.0.0
 */
class Finest_Video extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'            => 'youtube',
                'options'            => [
                    'youtube'     => __( 'YouTube', 'finest-addons' ),
                    'vimeo'       => __( 'Vimeo', 'finest-addons' ),
                    'dailymotion' => __( 'Dailymotion', 'finest-addons' ),
                    'hosted'      => __( 'Self Hosted', 'finest-addons' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder'        => __( 'Enter your URL', 'finest-addons' ) . ' (YouTube)',
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Enter your URL', 'finest-addons' ) . ' (Vimeo)',
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Enter your URL', 'finest-addons' ) . ' (Dailymotion)',
        ...
        $this->add_control(
            'insert_url',
            [
                'label'     => __( 'External URL', 'finest-addons' ),
        ...
        $this->add_control(
            'hosted_url',
            [
                'label'      => __( 'Choose File', 'finest-addons' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'media_type'   => 'video',
                'placeholder'  => __( 'Enter your URL', 'finest-addons' ),
                'condition'    => [
                    'video_type' => 'hosted',
                    'insert_url' => 'yes',
                ],
        ...
        $this->add_control(
            'start',
            [
                'label'              => __( 'Start Time', 'finest-addons' ),
                'type'               => Controls_Manager::NUMBER,
                'description'        => __( 'Specify a start time (in seconds)', 'finest-addons' ),
                'frontend_available' => true,
            ]
        );
        ...
        $this->add_control(
            'end',
            [
                'label'              => __( 'End Time', 'finest-addons' ),
                'type'               => Controls_Manager::NUMBER,
                'description'        => __( 'Specify an end time (in seconds)', 'finest-addons' ),
                'condition'          => [
        ...
        $this->add_control(
            'video_options',
            [
                'label'     => __( 'Video Options', 'finest-addons' ),
        ...
        $this->add_control(
            'autoplay',
            [
                'label'              => __( 'Autoplay', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'frontend_available' => true,
                'conditions'         => [
                    'relation' => 'or',
        ...
        $this->add_control(
            'play_on_mobile',
            [
                'label'              => __( 'Play On Mobile', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'condition'          => [
                    'autoplay' => 'yes',
                ],
        ...
        $this->add_control(
            'controls',
            [
                'label'              => __( 'Player Controls', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'showinfo',
            [
                'label'     => __( 'Video Info', 'finest-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'finest-addons' ),
                'label_on'  => __( 'Show', 'finest-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'modestbranding',
            [
                'label'              => __( 'Modest Branding', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'condition'          => [
                    'video_type' => ['youtube'],
                    'controls'   => 'yes',
        ...
        $this->add_control(
            'yt_privacy',
            [
                'label'              => __( 'Privacy Mode', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'description'        => __( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'finest-addons' ),
                'condition'          => [
                    'video_type' => 'youtube',
                ],
                'frontend_available' => true,
        ...
        $this->add_control(
            'lazy_load',
            [
                'label'              => __( 'Lazy Load', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'conditions'         => [
                    'relation' => 'or',
                    'terms'    => [
        ...
        $this->add_control(
            'rel',
            [
                'label'     => __( 'Suggested Videos', 'finest-addons' ),
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    ''    => __( 'Current Video Channel', 'finest-addons' ),
                    'yes' => __( 'Any Video', 'finest-addons' ),
                ],
                'condition' => [
                    'video_type' => 'youtube',
                ],
        ...
        $this->add_control(
            'vimeo_title',
            [
                'label'     => __( 'Intro Title', 'finest-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'finest-addons' ),
                'label_on'  => __( 'Show', 'finest-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'vimeo_portrait',
            [
                'label'     => __( 'Intro Portrait', 'finest-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'finest-addons' ),
                'label_on'  => __( 'Show', 'finest-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'vimeo_byline',
            [
                'label'     => __( 'Intro Byline', 'finest-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'finest-addons' ),
                'label_on'  => __( 'Show', 'finest-addons' ),
                'default'   => 'yes',
        ...
        $this->add_control(
            'color',
            [
                'label'     => __( 'Controls Color', 'finest-addons' ),
        ...
        $this->add_control(
            'download_button',
            [
                'label'     => __( 'Download Button', 'finest-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'label_off' => __( 'Hide', 'finest-addons' ),
                'label_on'  => __( 'Show', 'finest-addons' ),
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Image Overlay', 'finest-addons' ),
            ]
        );
        ...
        $this->add_control(
            'show_play_icon',
            [
                'label'     => __( 'Play Icon', 'finest-addons' ),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'show_image_overlay'  => 'yes',
        ...
        $this->add_control(
            'lightbox',
            [
                'label'              => __( 'Lightbox', 'finest-addons' ),
                'type'               => Controls_Manager::SWITCHER,
                'frontend_available' => true,
        ...
        $this->add_control(
            'aspect_ratio',
            [
                'label'              => __( 'Aspect Ratio', 'finest-addons' ),
                'type'               => Controls_Manager::SELECT,
                'options'            => [
                    '169' => '16:9',
                    '219' => '21:9',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    'text_shadow_type' => [
                        'label' => _x( 'Shadow', 'Text Shadow Control', 'finest-addons' ),
                    ],
                ],
                'condition'      => [
                    'show_image_overlay' => 'yes',
        ...
        $this->add_control(
            'lightbox_ui_color',
            [
                'label'     => __( 'UI Color', 'finest-addons' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'UI Hover Color', 'finest-addons' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'                => __( 'Content Position', 'finest-addons' ),
                'type'                 => Controls_Manager::SELECT,
                'frontend_available'   => true,
                'options'              => [
                    ''    => __( 'Center', 'finest-addons' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'              => __( 'Entrance Animation', 'finest-addons' ),
				...
				<div <?php echo $this->get_render_attribute_string( 'image-overlay' ); ?>>
					...
					<?php if ( 'yes' === $settings['show_play_icon'] ): ?>
						<div class="elementor-custom-embed-play" role="button">
							...
							<span class="elementor-screen-only"><?php echo __( 'Play Video', 'finest-addons' ); ?></span>
						</div>
					<?php endif;?>
				</div>
			<?php }?>
...
$widgets_manager->register_widget_type( new \Elementor\Finest_Video() );