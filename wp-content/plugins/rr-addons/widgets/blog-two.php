 ...
 * @since 1.0.0
 */
class BlogTwo extends \Elementor\Widget_Base
{
    /**
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Shear', 'rr-addons' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
    	$this->add_control(
   ...
   /*      $this->end_popover(); */
    ...
    protected function render()
    {
        ...
        <div class="advis-blog-wraper">
                ...
                <div class="blog-slider-arrow">
                    <?php if (!empty($settings['arrow_prev_icon']['value'])) : ?>
                        <button type="button" class="slick-prev prev slick-arrow slick-active prev-<?php echo esc_attr( $this->get_ID()); ?>">
                            ...
                            <a href="<?php the_permalink(); ?>"><?php echo '<img src="' . $settings['image-btn']['url'] . '">';?></a>
                        </button>
                    <?php endif; ?>
            ...
            <?php endif; ?>
            <div class="img">
                <a href="<?php the_permalink(); ?>"><?php echo '<img src="' . $settings['image']['url'] . '">';?></a>
            </div>
        </div>
...
$widgets_manager->register_widget_type(new \Finest_Addons\Widgets\BlogTwo());
