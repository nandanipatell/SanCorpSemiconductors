...
?>
<div id="post-<?php the_ID(); ?>"  class="<?php printf('techex-case-study-item-wrap %s %s %s' , $grid  , $pf_cat_slug , $image_height); ?>">
    <div class="techex-case-study-item ">
        <div class="techex-case-study-image d-block">
                ...
                <div class="techex-case-study-content <?php echo esc_attr( $settings['case_style'] ) ?> <?php echo esc_attr($settings['meta_postition']); ?> ">
                    ...
                    <!-- Category -->
                     <?php if (!empty($pf_cat_name) && 'yes' == $settings['show_category'] ): ?>
                        <a class="techex-cs-category" href="<?php the_permalink()?>">
                            ...
                            <?php } ?>
                            <? echo esc_html(ltrim($pf_cat_name, ",")); ?>
                        </a>
                    <?php endif; ?>
                    </div>
